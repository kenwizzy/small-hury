...
<div class="aside-body">
  <div class="aside-loggedin">
    <div class="d-flex align-items-center justify-content-start">
      <a href="" class="avatar"><img src="{{asset('assets/img/cal1.png')}}" class="rounded-circle" alt=""></a>
    ...
    <div class="collapse" id="loggedinMenu">
      <ul class="nav nav-aside mg-b-0">
        ...
        <li class="nav-item"><a href="{{url('dashboard/view_profile')}}" class="nav-link"><i data-feather="user"></i> <span>View Profile</span></a></li>
