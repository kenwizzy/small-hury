          ...
          <div class="tab-content">
            ...
            <div id="contactInformation" class="tab-pane show active pd-20 pd-xl-25">
              <div class="d-flex align-items-center justify-content-between mg-b-25">
                ...
                <div class="d-flex">
                  <a href="{{ url('quality-assurance.edit_profile',app()->getLocale()) }}" class="btn btn-sm btn-white d-flex align-items-center mg-r-5"><i data-feather="edit-2"></i><span class="d-none d-sm-inline mg-l-5"> Edit</span></a>
              ...
              <div class="row">
                <div class="col-6 col-sm">
                  ...
                  <p class="mg-b-0">{{$user->first_name}}</p></p>
                </div><!-- col -->
                <div class="col-6 col-sm">
